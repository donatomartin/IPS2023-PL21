...
public class Frame22784 extends JFrame {
	...
	private JList<String> listInstalacion;
	...
	private JPanel getPnListInstalacion() {
		if (pnListInstalacion == null) {
			...
			JScrollPane scpn = new JScrollPane(getListInstalacion());
			pnListInstalacion.add(scpn);
		}
		return pnListInstalacion;
	}

	private JList<String> getListInstalacion() {
		if (listInstalacion == null) {
			listInstalacion = new JList<String>();
			listInstalacion.addMouseListener(new MouseAdapter() {
				@Override
	...
	private JList<String> getListJardineros() {
		if (listJardineros == null) {
			listJardineros = new JList<String>();
		}
				...
				gl_pnSpinners.createParallelGroup(Alignment.TRAILING)
					.addGroup(gl_pnSpinners.createSequentialGroup()
						...
						.addGroup(gl_pnSpinners.createParallelGroup(Alignment.TRAILING)
							.addGroup(gl_pnSpinners.createSequentialGroup()
								.addGap(83)
								.addComponent(getSpHoraInicio(), GroupLayout.DEFAULT_SIZE, 62, Short.MAX_VALUE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(getSpHoraFin(), GroupLayout.DEFAULT_SIZE, 57, Short.MAX_VALUE))
							.addComponent(getSpFecha(), GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
							.addComponent(getBtnNewButton(), Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE))
						.addContainerGap())
			);
